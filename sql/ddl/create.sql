    ...
    create table course (
        ...
        semester varchar(255) not null check (semester in ('S1','S2','E')),
    ...
    create table school_class (
        ...
        dt_end time(6) not null,
        class_group varchar(255) not null,
        name varchar(255) not null,
        dt_start time(6) not null,
        course_fk bigint not null,
        room_fk bigint not null,
        teacher_fk uuid not null,
        primary key (id),
        constraint uk_school_class_name unique (group, name, course_fk)
    );
